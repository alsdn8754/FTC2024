        ...
        if (!isStopRequested()) {
            ...
            while (!isStopRequested()) {
                if (biconPosition == 1) {  //code RedC_trajLn
                    ...
                    drive.followTrajectory(RedC_trajL3_RP);  //move to parking zone and init arm position

                    drive.followTrajectory(RedC_trajL4_RP);  //move to parking zone
                    ...
                    drive.followTrajectory(RedC_trajM3_RP);  //move to parking zone and init arm position

                    drive.followTrajectory(RedC_trajM4_RP);  //move to parking zone
                    ...
                    drive.followTrajectory(RedC_trajR3_RP);  //move to parking zone and init arm position

                    drive.followTrajectory(RedC_trajR4_RP);  //move to parking zone
